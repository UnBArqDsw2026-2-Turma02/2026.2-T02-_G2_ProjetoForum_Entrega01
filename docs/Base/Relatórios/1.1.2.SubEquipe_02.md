...
disponível no [arquivo BPMN 2.0 no GitHub](https://github.com/UnBArqDsw2026-2-Turma02/2026.2-T02-_G2_ProjetoForum_Entrega01/blob/1264635b30c56794eb57db480ae5414f51390017/docs/Base/Modelagem/BPMN/Fluxo_Pergunta_Resposta_Resolucao.bpmn).
...
`Necessidade identificada → Publica pergunta → Disponibiliza pergunta → Responde e avalia → Acompanha contribuições → Pergunta fechada? → [Não] Resposta resolve? → [Sim] Marca resposta como aceita → Pergunta resolvida`
